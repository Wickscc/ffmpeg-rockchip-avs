...
static MppCodingType rkmpp_get_coding_type(AVCodecContext *avctx)
{
    ...
    case AV_CODEC_ID_AVS2:          return MPP_VIDEO_CodingAVS2;        // 添加 AVS2 编码类型
...
#endif
#if CONFIG_AVS_RKMPP_DECODER
DEFINE_RKMPP_DECODER(avs, AVS, NULL)
#endif
#if CONFIG_AVSPLUS_RKMPP_DECODER
DEFINE_RKMPP_DECODER(avsplus, "AVS+", NULL)
#endif
